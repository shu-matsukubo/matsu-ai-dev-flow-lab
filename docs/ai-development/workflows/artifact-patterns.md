...
Main、Worker、Reviewerは、担当scope内で高難度、高リスク、または判断困難な特定論点について、必要な入力と期待する出力を満たす独立した専門レビュー能力を追加相談として選択できる。相談後も作業主体、承認scope、成果物作成、通常review、verification、提出、最終判断は元の構成へ戻す。利用不能、入力不足、結果未取得は成功と区別して記録する。
